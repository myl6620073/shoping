...
class BackendFactory extends Container
{
            ...
            switch ($backendConfig['adapter']) {
                ...
                case 's3':
                    $this[$backendConfig['name']] = function () use ($backendConfig) {
                        ...
                        $config = array(
                            'visibility' => isset($backendConfig['visibility']) ? $backendConfig['visibility'] : 'priv'
                        );
    ...
    /**
     * Returns backend object for given priv directory identifier
     *
    ...
    public function getPrivateDirBackend($privateDirIdentifier)
    {
        ...
        // Create a default .htaccess to disable access to current priv directory
