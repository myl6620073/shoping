...
class AwsS3Adapter extends AbstractAdapter
{
    ...
    protected function getObjectACL($path)
    {
        ...
        return $metadata['visibility'] === AdapterInterface::VISIBILITY_PUBLIC ? 'public-read' : 'priv';
    }
    ...
    {
        $options = $this->getOptions($path, [
            'ACL' => $visibility === AdapterInterface::VISIBILITY_PUBLIC ? 'public-read' : 'priv',
        ]);
    ...
    protected function getOptionsFromConfig(Config $config)
    {
        ...
        if ($visibility = $config->get('visibility')) {
            ...
            $options['ACL'] = $visibility === AdapterInterface::VISIBILITY_PUBLIC ? 'public-read' : 'priv';
        }
