...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
     ...
     *
     *   * private_headers        Set of request headers that trigger "priv" cache-control behavior
     *                            on responses that don't explicitly state whether the response is
     *                            public or priv via a Cache-Control directive. (default: Authorization and Cookie)
     *
    ...
    protected function validate(Request $request, Response $entry, $catch = false)
    {
        ...
        // has a different priv valid entry which is not cached here.
     ...
     * that should cause the Response to be considered priv by default.
     *
     * @param Request $request A Request instance
     *
     * @return bool true if the Request is priv, false otherwise
     */
